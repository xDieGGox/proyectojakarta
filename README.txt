...
a persistence unit "proyectoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyecto/pom.xml":
...
artifact ("proyecto.war") is already built. You can build
